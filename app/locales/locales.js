const locales = {
    "en": {
        "headlines_title": "Next generation password manager",
    ...
    "fr": {
        "headlines_title": "Gestionnaire de mot de passe nouvelle génération",
        "headlines_subtitle": "LessPass ne mémorise pas vos mots de passe, et vous non plus !",
        "what_is_lesspass": "remplace tous vos outils qui sauvegarde vos mots de passe comme Lastpass, 1password, Keepass, tableur Excel, post it, etc...",
        "what_is_lesspass2": "regénère vos mots de passe à chaque fois que vous en avez besoin. Chaque mot de passe est unique et propre à chaque site. Tout ce dont vous avez besoin c'est de vous souvenir d'un seul mot de passe.",
