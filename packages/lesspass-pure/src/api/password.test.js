...
test("Passwords.all", () => {
  mock.onGet("https://www.lesspass.com/api/passwords/").reply(200, {});
...
test("Passwords.get", () => {
  mock
    .onGet(
      "https://www.lesspass.com/api/passwords/c8e4f983-8ffe-b705-4064-d3b7aa4a4782/"
    )
    .reply(200, {});
...
test("Passwords.update", () => {
  ...
  mock
    .onPut(
      "https://www.lesspass.com/api/passwords/c8e4f983-4064-8ffe-b705-d3b7aa4a4782/",
      password
    )
    .reply(200, {});
...
test("Passwords.delete", () => {
  mock
    .onDelete(
      "https://www.lesspass.com/api/passwords/c8e4f983-8ffe-4064-b705-d3b7aa4a4782/"
    )
    .reply(204);
